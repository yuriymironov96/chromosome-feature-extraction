...
from skeleton import get_skeleton_feature_from_image
...
targetdir = os.path.join(ROOT_OUTPUT_DIR, "clustering_chromosomes_skeleton_result")
number_clusters = 3
...
for i, imagepath in enumerate(filelist):
    ...
    feature = get_skeleton_feature_from_image(imagepath)

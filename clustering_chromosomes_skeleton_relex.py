...
from skeleton import get_skeleton_relex_feature_from_image
...
targetdir = os.path.join(
    ROOT_OUTPUT_DIR, "clustering_chromosomes_skeleton_relex_result")
number_clusters = 3

# Loop over files and get features
filelist = glob.glob(os.path.join(imdir, '*.jpg'))
filelist = [file for file in filelist if not os.path.split(
    file)[-1].startswith("_")]
filelist.sort()
...
for i, imagepath in enumerate(filelist):
    ...
    feature = get_skeleton_relex_feature_from_image(imagepath)
